package com.ranycess.commonview.viewGroup
...
class ConstraintLayoutR @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.textViewStyle
) : ConstraintLayout(context, attrs, defStyleAttr), CommonBackgroundStyleOperate {
